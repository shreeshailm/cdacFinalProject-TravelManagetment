...
function DeatilsofPackage() {
    ...
    return <>
        ...
        <ToastContainer position='top-right' autoClose={2500}/>
            <div class="container">
                <center><h2>Add details of Package</h2></center>
        ...
        <div className="container-fluid text-center" style={{ marginTop:20 }}>
            ...
            <div className="row content">
                ...
                <div className="col-lg-8 text-center">
                    ...
                    <div>
                        <br></br>
                        <button type="button" className="btn btn-success" onClick={updatePackage}>Add details</button>
...
export default DeatilsofPackage;